  ...
  methods: {
    addCount(e) {
      ...
      if (this.countNum % 50 == 0 && this.countNum > 0) {
        ...
        let gToast = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.children[1].children[2]
        ...
        let ToastP = e.target.parentNode.parentNode.parentNode.parentNode.parentNode.children[1].children[2].children[0]
